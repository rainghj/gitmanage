...
| 组件 | 版本要求 | 本机安装情况 |
| --- | --- | --- |
| Rust 工具链 | stable-msvc | 1.98.0，`C:\Users\guohj\.rustup` |
| VS Build Tools | 2022/2026「使用 C++ 的桌面开发」 | `C:\Program Files (x86)\Microsoft Visual Studio\18\BuildTools` |
| Node.js | ≥ 18 | v22.22.2 |
| pnpm | 任意 | 11.22.0 |
| WebView2 运行时 | Win11 自带 | 与 Edge 共用 |
